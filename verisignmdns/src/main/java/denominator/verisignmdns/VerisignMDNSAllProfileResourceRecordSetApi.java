...
public class VerisignMDNSAllProfileResourceRecordSetApi implements denominator.AllProfileResourceRecordSetApi {
	...
	VerisignMDNSAllProfileResourceRecordSetApi(
			Provider<Credentials> credentialsProvider, String domainName,
			VrsnMdns api) {
	...
	protected void put(Filter<ResourceRecordSet<?>> valid,
	 ...
	 */
	@Override
	public ResourceRecordSet<?> getByNameTypeAndQualifier(String name,
		...
		SortedSet<ResourceRecordSet<?>> rrSet = VrsnContentConversionHelper
	...
	@Override
	public void deleteByNameTypeAndQualifier(String name, String type,
			String qualifier) {
		// @ Keeping MOCK code for now...
		// @TODO IMPLEMENT -- in future development phase /////////
		throw new VrsnMdnsException("Method Not Implemented", -1);
	...
	static class Factory implements
			denominator.AllProfileResourceRecordSetApi.Factory {
		...
		public AllProfileResourceRecordSetApi create(String idOrName) {
			return new VerisignMDNSAllProfileResourceRecordSetApi(
					credentialsProvider, idOrName, api);
		}
	}
}
