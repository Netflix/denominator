...
public class LOCData extends NumbersAreUnsignedIntsLinkedHashMap {
	...
	@ConstructorProperties({ "latitude", "longitude", "altitude", "diameter", "hprecision", "vprecision" })
	LOCData(String latitude, String longitude, String altitude, String diameter, String hprecision, String vprecision) {
