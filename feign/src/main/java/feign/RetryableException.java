 ...
 * typically via an {@link ErrorDecoder} when the {@link Response#status()
 * status} is 503.
 */
public class RetryableException extends FeignException {
    ...
    /**
     * @param retryAfter
     *            usually corresponds to the {@link HttpHeaders#RETRY_AFTER}
     *            header.
     */
    ...
    /**
     * Sometimes corresponds to the {@link HttpHeaders#RETRY_AFTER} header
