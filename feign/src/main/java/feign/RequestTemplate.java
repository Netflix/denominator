...
public final class RequestTemplate implements Serializable {
    ...
    /**
     * A templatized form for a PUT or POST command. Values of {@link PathParm},
     * {@link QueryParam}, {@link HeaderParam}, and {@link FormParam} can be
    ...
    /**
     * <p/>
     * This is roughly analogous to {@code javax.ws.rs.client.Target.request()}.
     */
     ...
     * 
     * Note that if you'd like curly braces literally in the {@link template},
     * urlencode them first.
     * 
     * @param template
     *            URI template that can be in level 1 <a
     ...
     * {@link values} supplied.
     * <p/>
     * When the {@link value} is {@code null}, all queries with the {@link key}
     * are removed.
     * 
     * <h4>relationship to JAXRS 2.0</h4>
     * <p/>
     ...
     * {@link values} supplied.
     * <p/>
     * When the {@link value} is {@code null}, all headers with the {@link key}
     * are removed.
     * 
     * <h4>relationship to JAXRS 2.0</h4>
     * <p/>
     * Like {@code WebTarget.queries} and {@link Invocation.Builder.header},
