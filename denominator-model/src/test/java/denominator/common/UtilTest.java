...
public class UtilTest {
    ...
    public void concatIteratorsWhenPresent() {
        Iterator<Boolean> it = concat(TrueThenDone.INSTANCE.iterator(), TrueThenDone.INSTANCE.iterator());
        assertTrue(it.hasNext());
        assertTrue(it.next());
        assertTrue(it.hasNext());
        assertTrue(it.next());
    ...
    public void concatIterablesWhenFirstIsEmpty() {
        Iterator<Boolean> it = concat(ImmutableList.of(ImmutableList.<Boolean> of(), ImmutableList.of(true)));
        assertTrue(it.hasNext());
        assertTrue(it.next());
        assertFalse(it.hasNext());
    }
