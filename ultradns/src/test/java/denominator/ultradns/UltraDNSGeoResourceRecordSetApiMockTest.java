...
//
  ...
  ResourceRecordSet<CNAMEData> europe = ResourceRecordSet
      ...
      .geo(Geo.create(ImmutableMultimap.<String, String>builder().orderKeysBy(Ordering.natural())
                          .putAll("Europe", "Aland Islands", "Albania", "Andorra", "Armenia",
                                  "Austria",
                                  "Azerbaijan", "Belarus", "Belgium", "Bosnia-Herzegovina",
                                  "Bulgaria", "Croatia",
                                  "Czech Republic", "Denmark", "Estonia", "Faroe Islands",
                                  "Finland", "France",
                                  "Georgia", "Germany", "Gibraltar", "Greece", "Guernsey",
                                  "Hungary", "Iceland",
  ...
  ResourceRecordSet<CNAMEData> us = ResourceRecordSet
      ...
      .geo(Geo.create(ImmutableMultimap.<String, String>builder()
                          .putAll("United States (US)", "Alabama", "Alaska", "Arizona", "Arkansas",
                                  ...
                                  "Texas",
                                  "Undefined United States", "United States Minor Outlying Islands",
                                  "Utah",
  ...
  ResourceRecordSet<CNAMEData> everywhereElse = ResourceRecordSet
      ...
      .geo(Geo.create(ImmutableMultimap.<String, String>builder().orderKeysBy(Ordering.natural())
                          ...
                          .putAll("Canada (CA)", "Alberta", "British Columbia", "Greenland",
                                  "Manitoba",
                                  "New Brunswick", "Newfoundland and Labrador",
                                  "Northwest Territories",
                                  "Nova Scotia", "Nunavut", "Ontario", "Prince Edward Island",
                                  "Quebec",
                                  "Saint Pierre and Miquelon", "Saskatchewan", "Undefined Canada",
                                  "Yukon")
                          .putAll("The Caribbean", "Anguilla", "Antigua and Barbuda", "Aruba",
                                  "Bahamas", "Barbados",
                          ...
                          .putAll("Africa", "Algeria", "Angola", "Benin", "Botswana",
                                  ...
                                  "Togo", "Tunisia", "Uganda", "Undefined Africa", "Western Sahara",
                                  "Zambia",
                                  "Zimbabwe")
                          .putAll("Asia", "Bangladesh", "Bhutan",
                                  ...
                                  "Undefined Asia",
                                  "Uzbekistan", "Vietnam")
                          .putAll("Australia / Oceania", "American Samoa", "Australia",
                                  "Christmas Island",
                                  ...
                                  "New Zealand",
                                  "Niue", "Norfolk Island",
                                  "Northern Mariana Islands, Commonwealth of", "Palau",
                                  "Papua New Guinea", "Pitcairn", "Samoa", "Solomon Islands",
                                  "Tokelau", "Tonga",
                                  "Tuvalu", "Undefined Australia / Oceania", "Vanuatu",
                                  "Wallis and Futuna")
                          .putAll("Antarctica", "Antarctica", "Bouvet Island",
                                  "French Southern Territories").build()
                          .asMap())).build();
  ...
  public void listWhenPresent() throws IOException, InterruptedException {
    ...
    try {
      ...
      assertEquals(new String(server.takeRequest().getBody()),
                   UltraDNSTest.getDirectionalPoolsOfZone);
      ...
      for (String groupId : ImmutableList
          .of("C000000000000001", "C000000000000003", "C000000000000002")) {
        ...
        assertEquals(new String(getDirectionalDNSGroupDetails.getBody()),
                     UltraDNSTest.getDirectionalDNSGroupDetails
                         .replace("AAAAAAAAAAAAAAAA", groupId));
      }
