...
public class UltraDNSTest {
  ...
  static String
      SOAP_TEMPLATE =
      format(denominator.ultradns.UltraDNSTarget.SOAP_TEMPLATE, "joe", "letmein", "%s");
  /**
...
//
  ...
  static String
      poolNotFound =
      format(FAULT_TEMPLATE, POOL_NOT_FOUND, "Pool does not exist in the system");
...
//
  ...
  static String
      getDirectionalDNSRecordsForHost =
...
//
  ...
  static String
      getDirectionalDNSRecordsForGroup =
...
//
  ...
  public void zonesOfAccountPresent() throws IOException, InterruptedException {
    ...
    try {
      assertEquals(mockApi(server.getPort()).getZonesOfAccount("AAAAAAAAAAAAAAAA"),
                   ImmutableList.of(Zone.create("denominator.io."),
                                    Zone.create("0.1.2.3.4.5.6.7.ip6.arpa.")));
  ...
  public void recordsInZonePresent() throws IOException, InterruptedException, ParseException {
    ...
    try {
      ...
      assertEquals(records.get(0).created,
                   iso8601SimpleDateFormat.parse("2009-10-12T12:02:23.000Z"));
  ...
  @Test
  public void recordsInZoneByNameAndTypePresent()
    ...
    try {
      List<Record>
          records =
          mockApi(server.getPort()).getResourceRecordsOfDNameByType("denominator.io.",
                                                                    "denominator.io.", 6);
      assertEquals(records.size(), 1);
      checkSOARecord(records.get(0));

      assertEquals(new String(server.takeRequest().getBody()),
                   format(getResourceRecordsOfDNameByType));
    } finally {
      server.shutdown();
    }
  }
    ...
    try {
      assertEquals(
          mockApi(server.getPort())
              .getResourceRecordsOfDNameByType("denominator.io.", "denominator.io.", 6),
          ImmutableList.of());
  ...
  public void rrPoolNameTypeToIdInZonePresent() throws IOException, InterruptedException {
    ...
    try {
      Map<NameAndType, String>
          pools =
          mockApi(server.getPort()).getLoadBalancingPoolsByZone("denominator.io.");
  ...
  public void rrPoolNameTypeToIdInZoneAbsent() throws IOException, InterruptedException {
    ...
    try {
      assertTrue(
          mockApi(server.getPort()).getLoadBalancingPoolsByZone("denominator.io.").isEmpty());
  ...
  public void createRRPoolInZoneForNameAndTypeWhenAlreadyExists()
  ...
  public void addRecordIntoRRPoolInZone() throws IOException, InterruptedException {
    ...
    try {
      mockApi(server.getPort())
          .addRecordToRRPool(1, 300, "www1.denominator.io.", "AAAAAAAAAAAAAAAA",
                             "denominator.io.");
  ...
  public void dirPoolNameToIdsInZonePresent() throws IOException, InterruptedException {
    ...
    try {
      Map<String, String>
          pools =
          mockApi(server.getPort()).getDirectionalPoolsOfZone("denominator.io.");
  ...
  @Test
  public void directionalRecordsByNameAndTypePresent()
      throws IOException, InterruptedException, ParseException {
    MockWebServer server = new MockWebServer();
    ...
    try {
      ...
      assertEquals(new String(server.takeRequest().getBody()),
                   format(getDirectionalDNSRecordsForHost));
    } finally {
      server.shutdown();
    }
  }
  ...
  public void directionalRecordsByNameAndTypeWhenPoolNotFound()
    ...
    try {
      mockApi(server.getPort())
          .getDirectionalDNSRecordsForHost("denominator.io.", "www.denominator.io.", 0);
    } finally {
      server.shutdown();
    }
  }
  ...
  @Test
  public void directionalRecordsByNameAndTypeFiltersOutSourceIP()
      throws IOException, InterruptedException {
    MockWebServer server = new MockWebServer();
    server.enqueue(
  ...
  @Test
  public void directionalRecordsInZoneAndGroupByNameAndTypePresent()
      throws IOException, InterruptedException,
             ParseException {
    MockWebServer server = new MockWebServer();
    ...
    try {
      ...
      assertEquals(new String(server.takeRequest().getBody()),
                   format(getDirectionalDNSRecordsForGroup));
    } finally {
      server.shutdown();
    }
  }
  ...
  @Test
  public void directionalRecordsInZoneAndGroupByNameAndTypeAbsent()
      throws IOException, InterruptedException {
    MockWebServer server = new MockWebServer();
  ...
  public void createDirectionalPoolInZoneForNameAndType() throws IOException, InterruptedException {
    ...
    try {
      assertEquals(mockApi(server.getPort())
  ...
  public void createDirectionalPoolInZoneForNameAndTypeWhenAlreadyExists()
      throws IOException, InterruptedException {
    MockWebServer server = new MockWebServer();
    server.enqueue(new MockResponse().setResponseCode(500).setBody(poolAlreadyExists));
    server.play();
  ...
  public void createDirectionalRecordAndGroupInPool() throws IOException, InterruptedException {
    ...
    try {
      ...
      assertEquals(
          mockApi(server.getPort()).addDirectionalPoolRecord(record, group, "AAAAAAAAAAAAAAAA"),
          "06063DC355058294");
  ...
  public void createDirectionalRecordAndGroupInPoolWhenExists()
      throws IOException, InterruptedException {
    MockWebServer server = new MockWebServer();
  ...
  public void updateDirectionalRecordAndGroupWhenExistsWithSameAttributes()
      throws IOException, InterruptedException {
    MockWebServer server = new MockWebServer();
  ...
  public void getDirectionalGroup() throws IOException, InterruptedException {
    ...
    try {
      DirectionalGroup
          group =
          mockApi(server.getPort()).getDirectionalDNSGroupDetails("AAAAAAAAAAAAAAAA");
      assertEquals(group.name, "Europe");
      assertEquals(group.regionToTerritories.get("Europe"),
                   ImmutableSet.of("Aland Islands", "Albania",
