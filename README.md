...
Here's how to get denominator-cli `4.1.0` from [bintray](https://bintray.com/pkg/show/general/netflixoss/denominator/denominator-cli)

1. [Download denominator](http://dl.bintray.com/content/netflixoss/denominator/denominator-cli/release/4.1.0/denominator?direct)
...
The current version of denominator is `4.1.0`
