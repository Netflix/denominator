...
Here's how to get denominator-cli `3.6.0` from [bintray](https://bintray.com/pkg/show/general/netflixoss/denominator/denominator-cli)

1. [Download denominator](http://dl.bintray.com/content/netflixoss/denominator/denominator-cli/release/3.6.0/denominator?direct)
...
The current version of denominator is `3.6.0`
